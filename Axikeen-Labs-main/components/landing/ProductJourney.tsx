        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-6">
          {journey.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="relative rounded-lg bg-surface p-6 h-full border border-border shadow-sm">
                  <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-primary-light text-primary shadow-sm">
                      <Icon size={20} />
                    </div>
